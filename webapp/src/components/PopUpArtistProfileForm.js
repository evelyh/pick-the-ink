...
function PopUpArtistProfileForm(props) {
    ...
    const [prev] = useState({
        ...
        artistSub: props.info.artistSub,
        homeLocation: props.info.homeLocation,
        profilePic: props.info.profilePic
    });
    ...
    const onChangeLocation = async (val) => 
    {
        setRegion(val) 
        // region = val;
        console.log("onchangecountry:"+country)
        console.log("onchangeregion:"+region)
        ...
        {   
            ...
            // props.setInfo({...props.info, homeLocation: country + " " + val})

            let copy = {...props.info.artistSub};
            copy.homeLocation = locationID._id;
            console.log(copy)
            props.setInfo({...props.info, artistSub:_.cloneDeep(copy)});
            // props.artistSub.homeLocation = locationID._id;
            // props.artistSub = _.cloneDeep(copy)
